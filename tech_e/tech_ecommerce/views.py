...
class OptionViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        serializers = OptionSerializer(queryset, many=True)
        return Response(serializers.data)
...
list_filters = [
    {
        ...
        "Price": [
            {"display_value": "Dưới 2.500.000", "query_value": "16GB"},
            {"display_value": "2.500.000 -> 6.000.000", "query_value": "32GB"},
            {"display_value": "6.000.000 -> 25.500.000", "query_value": "64GB"},
            {"display_value": "Trên 25.500.000", "query_value": "128GB"},
        ]
    }
]
